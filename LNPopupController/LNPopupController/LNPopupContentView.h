 ...
 *
 * Note: No longer supported. Instead, implement @c UIViewController.positionPopupCloseButton() and position the button in your content controller's view hierarchy.
 */
